...
#ifndef ItThink_FINGERPRINT_H

#define ItThink_FINGERPRINT_H

/*!
 * @file ItThink_Fingerprint.h
 */
...
/* Auto Enroll and Verify (+v1.2) */
#define FINGERPRINT_AUTO_ENROLL 0x31
#define FINGERPRINT_AUTO_ENROLL_TIMEOUT 0x26
#define FINGERPRINT_AUTO_ENROLL_STORAGE_TEMPLATE 0x0F
#define FINGERPRINT_AUTO_ENROLL_ALREADY_EXISTS 0x27

#define FINGERPRINT_AUTO_VERIFY 0x32
#define FINGERPRINT_AUTO_VERIFY_SEARCH_STEP 0x03
#define FINGERPRINT_AUTO_VERIFY_FAIL 0x01
#define FINGERPRINT_AUTO_VERIFY_FAILED_SEARCH 0x09
...
struct ItThink_Fingerprint_Packet
{
  ...
  */
  ...
  ItThink_Fingerprint_Packet(uint8_t type, uint16_t length, uint8_t *data)
  {
...
class ItThink_Fingerprint
{
public:
#if defined(__AVR__) || defined(ESP8266) || defined(FREEDOM_E300_HIFIVE1)
  ItThink_Fingerprint(SoftwareSerial *ss, uint32_t password = 0x0);
#endif
  ItThink_Fingerprint(HardwareSerial *hs, uint32_t password = 0x0);
  ItThink_Fingerprint(Stream *serial, uint32_t password = 0x0);
  ...
  char firmware_version[32]; //< The firmware version as string (set by getFirmwareVersion)
